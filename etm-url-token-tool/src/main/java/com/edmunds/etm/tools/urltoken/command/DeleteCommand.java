...
public class DeleteCommand implements Command {
    ...
    @Autowired
    public DeleteCommand(UrlTokenRepository urlTokenRepository, OutputWriter outputWriter) {
    ...
    public String getDescription() {
        return "Delete a URL token.";
    }

    @Override
    public String getUsage() {
        return "delete TOKENNAME";
    }
    ...
    public void execute(String[] args) {
        ...
        try {
            urlTokenRepository.deleteToken(tokenName);
